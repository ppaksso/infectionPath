...
int ifctdb_addTail(void* obj);          //add data to tail 새로운 데이터를 추가하는 거 (Linked List) void포인터 변수로 받음
...
void* ifctdb_getData(int index);        //get index'th data 몇 번쨰인지 index 집어 넣으면 그 몇번째 node에 들어있는  데이터의 void 포인터를 리턴해줌 
